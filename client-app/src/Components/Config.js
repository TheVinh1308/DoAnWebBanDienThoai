            ...
            <aside  >
                <Row>
                    ...
                    <Col >
                        ...
                        <div >
                            <Modal show={showModal} onHide={handleCloseModal} dialogClassName="custom-modal" style={{ transform: checkClick ? 'translateX(-20%)' : 'none', overflow: 'hidden' }}  >
                                ...
                                <Modal.Footer>
                                    ...
                                    <Button style={{ backgroundColor: '#FFD93D', borderColor: '#4F200D', color: '#4F200D' }} onClick={handleCompara}  >
                                        <FontAwesomeIcon icon={faCirclePlus} /><span style={{ paddingLeft: 10 }} >Thêm so sánh</span>
                                    </Button>
                                </Modal.Footer>
                            </Modal>
                            <Modal show={showCompare} dialogClassName="custom-modal" style={{ transform: checkClick ? 'translateX(20%)' : 'none' }}  >
